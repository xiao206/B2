...
<template>
  <el-container class="min-h-screen bg-zinc-50">
    <el-aside width="240px" class="border-r border-zinc-200 bg-white">
      <div class="px-4 py-4">
        <div class="text-sm font-semibold text-zinc-900">平台管理</div>
        <div class="mt-1 text-xs text-zinc-500">管理员控制台</div>
      </div>
    ...
    <el-container>
      <el-header class="flex items-center justify-between border-b border-zinc-200 bg-white">
        <div class="text-sm text-zinc-700">{{ route.meta.title ?? '管理端' }}</div>
